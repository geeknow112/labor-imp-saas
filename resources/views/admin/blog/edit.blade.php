    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-900">記事編集</h1>
            ...
            <form method="POST" action="{{ route('admin.blog.update', $post->filename) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="date" id="date" value="{{ old('date', $post->date) }}" 
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" id="content" rows="20" 
                              class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" 
                              placeholder="Markdownで記事を書いてください..." required>{{ old('content', $post->content) }}</textarea>
                </div>
